...
// RUN : imatecc gen_md -title DS4 -object "ZPM_F0013" -output "ZPmF0013.cs" -nspace "NAMHE.Model" -mtype "proxy" -serial "field"
...
{
/// <summary>
    /// ZPMF0013Model(ZPM_F0013) Proxy class
    /// </summary>
    public class ZPMF0013Model
    {
        /// <summary>
        /// E_MSG(eMsg) Field
        /// </summary>
        ...
        /// <summary>
        /// I_TPLNR(iTplnr) Field
        /// </summary>
        public System.String I_TPLNR { get; set; }

        /// <summary>
        /// I_TPLNR_DESC(iTPLNRDesc) Field
        /// </summary>
        public System.String I_TPLNR_DESC { get; set; }

        /// <summary>
        /// ET_DATA(eTData) Field
        /// </summary>
        public IList<ZPMS0013Model> ET_DATA
        {
            get;
            set;
        }
...
/// <summary>
    /// ZPMS0013Model(ZPMS0013) Proxy class
    /// </summary>
    public class ZPMS0013Model
    {
        /// <summary>
        /// TPLNR(tplnr) Field
        /// </summary>
...
/// <summary>
    /// ZPMF0013Model(ZPM_F0013) Proxy List Class
    /// </summary>    
    public class ZPMF0013ModelList  : List<ZPMF0013Model>
    {
        /// <summary>
        /// 생성자
        /// </summary>
        public ZPMF0013ModelList()
        {
            return;
        }
    }
