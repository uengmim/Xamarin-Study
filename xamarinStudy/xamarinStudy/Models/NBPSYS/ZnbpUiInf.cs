...
// RUN : imatecc gen_md -title DS4 -object "ZNBP_UIINF" -output "ZnbpUiInf.cs" -nspace "NAMHE.Model" -mtype "proxy" -serial "field"
...
{
/// <summary>
    /// ZNBPUiinfModel(ZNBP_UIINF) Proxy class
    /// </summary>
    public class ZNBPUiinfModel
    {
        /// <summary>
        /// APPID(appid) Field
        /// </summary>
        ...
        /// UINM(uinm) Field
        /// </summary>
        public System.String UINM { get; set; }
...
/// <summary>
    /// ZNBPUiinfModel(ZNBP_UIINF) Proxy List Class
    /// </summary>    
    public class ZNBPUiinfModelList  : List<ZNBPUiinfModel>
    {
        /// <summary>
        /// 생성자
        /// </summary>
        public ZNBPUiinfModelList()
        {
            return;
        }
    }
