...
// RUN : imatecc gen_md -title DS4 -object "ZNBP_ROMN" -output "ZnbpRomn.cs" -nspace "NAMHE.Model" -mtype "proxy" -serial "field"
...
{
/// <summary>
    /// ZNBPRomnModel(ZNBP_ROMN) Proxy class
    /// </summary>
    public class ZNBPRomnModel
    {
        /// <summary>
        /// MNUID(mnuid) Field
        /// </summary>
        ...
        /// UIID(uiid) Field
        /// </summary>
        public System.String UIID { get; set; }

        /// <summary>
        /// MNUTYP(mnutyp) Field
        /// </summary>
        public System.String MNUTYP { get; set; }

        /// <summary>
        /// MNUNM(mnunm) Field
        /// </summary>
        public System.String MNUNM { get; set; }

        /// <summary>
        /// PMNUID(pmnuid) Field
        /// </summary>
        public System.String PMNUID { get; set; }

        /// <summary>
        /// ORGTYP(orgtyp) Field
        /// </summary>
        public System.String ORGTYP { get; set; }
...
/// <summary>
    /// ZNBPRomnModel(ZNBP_ROMN) Proxy List Class
    /// </summary>    
    public class ZNBPRomnModelList  : List<ZNBPRomnModel>
    {
        /// <summary>
        /// 생성자
        /// </summary>
        public ZNBPRomnModelList()
        {
            return;
        }
    }
