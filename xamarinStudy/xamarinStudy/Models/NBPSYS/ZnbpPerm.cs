...
// RUN : imatecc gen_md -title DS4 -object "ZNBP_PERM" -output "ZnbpPerm.cs" -nspace "NAMHE.Model" -mtype "proxy" -serial "field"
...
{
/// <summary>
    /// ZNBPPermModel(ZNBP_PERM) Proxy class
    /// </summary>
    public class ZNBPPermModel
    {
        /// <summary>
        /// APPID(appid) Field
        /// </summary>
        ...
        /// <summary>
        /// PERMDES(permdes) Field
        /// </summary>
        public System.String PERMDES { get; set; }
...
/// <summary>
    /// ZNBPPermModel(ZNBP_PERM) Proxy List Class
    /// </summary>    
    public class ZNBPPermModelList  : List<ZNBPPermModel>
    {
        /// <summary>
        /// 생성자
        /// </summary>
        public ZNBPPermModelList()
        {
            return;
        }
    }
