...
// RUN : imatecc gen_md -title DS4 -object "ZNBP_APPINF" -output "ZnbpAppinf.cs" -nspace "NAMHE.Model" -mtype "proxy" -serial "field"
...
{
/// <summary>
    /// ZNBPAppinfModel(ZNBP_APPINF) Proxy class
    /// </summary>
    public class ZNBPAppinfModel
    {
        /// <summary>
        /// APPID(appid) Field
        /// </summary>
        ...
        /// APPNM(appnm) Field
        /// </summary>
        public System.String APPNM { get; set; }
...
/// <summary>
    /// ZNBPAppinfModel(ZNBP_APPINF) Proxy List Class
    /// </summary>    
    public class ZNBPAppinfModelList  : List<ZNBPAppinfModel>
    {
        /// <summary>
        /// 생성자
        /// </summary>
        public ZNBPAppinfModelList()
        {
            return;
        }
    }
